/*
 *  Translate.java Copyright (C) 2003-2004 by Peter Eastman, modifications (C) 2005 by Francois Guillet
 ...
 */
/*
 *  Renamed to PMTranslate.java for use in the polymesh package
 */
...
public class PMTranslate
{
    ...
    {
        locale = l;
        resources = ResourceBundle.getBundle( "polymesh", locale );
    }
